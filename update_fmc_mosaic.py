...
fmc_stack_path = "/g/data/ub8/au/FMC/2020/fmc_c6_{}_{}.nc"
...
def update_fmc_mosaic(date, n_band, dst, tmp, comp):
    ...
    fmc_mean = compose_mosaic(date, n_band, "lfmc", gdal.GDT_Float32)
    fmc_stdv = compose_mosaic(date, n_band, "lfmc_uncertainty", gdal.GDT_Float32)
