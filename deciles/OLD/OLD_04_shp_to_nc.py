...
if not os.path.exists(nc_plg_path_file):
    ...
    cmd_rasterize = 'gdal_rasterize -l' + ' ' + shp_layer + ' -a ' + att_filed + ' -tr 0.005 0.005 -a_nodata -9999.0 -te 113.0 -43.995 154.0 -9.995 -ot Float32 -of netCDF -co WRITE_BOTTOMUP=NO ' + shp_plg_path_file + ' ' + nc_plg_path_file + '"'
...
if not os.path.exists(nc_plg_path_file):
    shp_plg_path_file = '/g/data/xc0/project/FMC_Australia/calc_deciles/data/FWA/gfe_fire_weather_wgs_84_v2.shp'
...
if not os.path.exists(nc_plg_path_file):
    shp_plg_path_file = '/g/data/xc0/project/FMC_Australia/calc_deciles/data/States/aus_states_WGS_84.shp'
