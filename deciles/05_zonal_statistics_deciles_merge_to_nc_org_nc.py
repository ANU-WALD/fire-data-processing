...
zst_nc_path_file = '/g/data/ub8/au/FMC/c6/mosaics/deciles/zonal_stats' + '/' + plg_name + '_' + nc_var_short + '_nc_zonal_stat.nc'
zst_csv_path_file = '/g/data/ub8/au/FMC/c6/mosaics/deciles/zonal_stats' + '/' + plg_name + '_' + nc_var_short + '_nc_zonal_stat.csv'

zst_nc_temp_path_file0 = zst_temp_path + '/' + plg_name + '_' + nc_var_short + '_nc_zonal_stat_time_double.nc'
zst_nc_temp_path_file = zst_temp_path + '/' + plg_name + '_' + nc_var_short + '_nc_zonal_stat.nc'
...
zst_csv_temp_path_file = zst_temp_path + '/' + plg_name + '_' + nc_var_short + '_nc_zonal_stat.csv'

zst_list = []
zst_temp_path_files = glob.glob(zst_temp_path + '/*' + plg_name + '*__nc_zonal_stat.pk')
