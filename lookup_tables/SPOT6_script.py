...
data_set = pd.read_excel('SPOT_sensitivity.xlsx', sheetname=which_satellite, index_col=0)
modis_lookup = pd.DataFrame(continuous_lookup[['cab', 'chp', 'cm', 'cw', 'fcov', 'fmc', 'lai', 'landcover']])

data_set.rename(columns={'B0(Blue)':'band_0_blue', 'B1(Green)':'band_1_green', 'B2(Red)':'band_2_red', 'B3(NIR)':'band_3_nir'}, inplace=True)
